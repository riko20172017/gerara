...
// WiFi settings
const char ssid[] = "adm";
const char password[] = "gBpOU@kBGtk$2025";

// WireGuard settings
IPAddress local_ip(10, 8, 0, 21);                                       // IP address of the local interface
const char private_key[] = "YJUfN4VXtdg301qR6ax0ESxE4Oy9dYVcgBFv94qY22k=";    // Private key of the local interface
const char endpoint_address[] = "178.208.65.214";                            // Address of the endpoint peer
const char public_key[] = "ow/a2iJfMOqpvEiiv8uMnyAkmhidSiOXWFK+jtte1D0=";     // Public key of the endpoint peer
const char preshared_key[] = "JiBq0k/RzSJPIhq4qQgmSWOmK2cRBPuhlW0yEHQVIXU=";  // Pre-Shared Key
